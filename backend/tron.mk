...
DOCKER_IMAGE = lissteron/cloudsuny

VERSION  := $(shell git describe --tags --always)
GIT_HASH := $(shell git rev-parse HEAD 2> /dev/null)
BUILD_TS := $(shell date +%FT%T%z)

LDFLAGS:=-X 'github.com/loghole/tron/internal/app.ServiceName=cloudsuny' \
		 -X 'github.com/loghole/tron/internal/app.AppName=github.com/lissteron/cloudsuny' \
...
run-local:
	go run -ldflags "$(LDFLAGS)" cmd/cloudsuny/main.go --local-config-enabled
